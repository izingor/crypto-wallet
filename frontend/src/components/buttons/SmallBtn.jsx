export const SmallBtn = ({ txt = null, type = null, handleClick = null }) => {
	const btnClass = () => {
		if (type === 'buy') {
			return 'text-white bg-blue-700 rounded hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium  text-sm px-5 py-2.5 text-center'
		} else if (type === 'back') {
			...
			return 'text-white bg-yellow-400 rounded hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium  text-sm px-5 py-2.5 text-center'
		}
	}
