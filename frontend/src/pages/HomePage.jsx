...
export function HomePage() {
	...
	return (
		...
		<div className='w-full h-full container grid grid-cols-6 grid-rows-4 sm:grid-rows-6 gap-4 font-mono'>
			<div className='ml-5 mt-5 col-start-1 col-end-7 row-start-1 row-end-2 sm:row-start-2 sm:row-end-3 flex flex-col items-start justify-center '>
				{!user ? (
					<>
			...
			<div className='col-start-1 col-end-7 row-start-2 row-end-5  sm:col-start-3 sm:col-end-7 sm:row-start-2 sm:row-end-7 flex flex-col items-start justify-center'>
